...
class HelloLaplace(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "HelloLaplace" # TODO make this more human readable by adding spaces
...
class HelloLaplaceTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_HelloLaplace1()

  def test_HelloLaplace1(self):
